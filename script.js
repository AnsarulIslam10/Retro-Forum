...
const displayAllPost = (posts) => {
  ...
  posts.forEach((post) => {
    ...
    div.innerHTML = `
    <div class="p-6 lg:p-12 flex gap-6 md:flex-row flex-col items-center lg:items-start bg-[#F3F3F5] rounded-3xl">
            <div class="indicator">
              ...
              <div class="flex justify-between *:font-bold [&>*:not(:last-child)]:opacity-45">
                ...
                <div class="opacity-100">
                  <button id="addToList" onclick="markAsRead('${
                    post.description
                  }', '${post.view_count}')" date-post='${JSON.stringify(post)}'
...
const displayLatestPosts = (datas) => {
          ...
          <div class="p-5 lg:p-10 space-y-4 lg:space-y-5">
            <p class="opacity-50 text-start">
              <i class="fa-solid fa-calendar-days me-2"></i>${
                e.author?.posted_date || "No Publish Date"
              }
            </p>
